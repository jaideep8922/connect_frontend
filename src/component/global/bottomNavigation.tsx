        ...
        <div>
            ...
            <nav className="fixed bottom-0 left-0 right-0 bg-white shadow-2xl z-50 border-t w-full px-3">
                <div className="flex justify-between items-center">
                    ...
                    <button
                        className={`flex flex-col items-center space-y-1 ${isActive('/profile') ? 'bg-blue-200 p-3 ' : 'p-3'
                            }`}
                    ...
                    <button
                        className={`flex flex-col items-center space-y-1 ${isActive('/home') ? 'bg-blue-200 p-3' : 'p-3'
                            }`}
                    ...
                    {userType === "Retailer" && (
                        <button
                            className={`flex flex-col items-center space-y-1 ${isActive('/shop') ? 'bg-blue-200 p-3' : 'p-3'
                                }`}
                    ...
                    {userType === "Supplier" && (
                        <>
                            <button
                                className={`flex flex-col items-center space-y-1 ${isActive('/manage') ? 'bg-blue-200 p-3' : 'p-3'
                                    }`}
                    ...
                    <button
                        className={`flex flex-col items-center space-y-1 ${isActive('/notes') ? 'bg-blue-200 p-3' : 'p-3'
                            }`}
                    ...
                    {userType === "Retailer" && (
                        ...
                        <a href={`tel:${phoneNo}`}
                            className={`flex flex-col items-center space-y-1 ${isActive('/') ? 'bg-blue-200 p-3' : 'p-3'
                                }`}
                        >
