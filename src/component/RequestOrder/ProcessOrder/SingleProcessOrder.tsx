...
export default function SingleOrderProcessMain() {
    return (
        <>
            <header className="sticky top-0 z-10 flex h-20 items-center justify-between border-b bg-white px-4">
                ...
                <h1 className="text-lg font-medium">Processed Order</h1>
            ...
            <div className="max-w-md mx-auto p-4 bg-white">
                ...
                <div className="bg-white rounded-xl shadow-sm border p-4 mb-4">
                    <div className="flex justify-between items-start mb-4">
                        ...
                        <span className="px-3 py-1 bg-green-300 text-green-800 rounded-full text-sm">
                            Pending
                        </span>
                    </div>
                ...
                <div className="bg-white rounded-xl shadow-sm border p-4 relative">
                    <div className="flex justify-between items-center mb-4">
                        ...
                        <span className="px-2 py-1 bg-green-300 text-green-800 text-xs rounded-full">
                            Pending
                        </span>
                    </div>
