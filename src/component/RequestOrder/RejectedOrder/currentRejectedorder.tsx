  ...
  useEffect(() => {
    if (typeof window !== "undefined") {
      ...
      try {
        ...
        if (!customId) {
          console.error("No customId found in userDetails");
          return;
        }
    ...
    <>
      ...
      <div className="max-w-md mx-auto p-4 space-y-4">
        <div className="max-w-sm mx-auto rounded-lg border bg-white p-4 shadow-sm">
          ...
          <hr className="my-4 border-dashed" />
          <div className="flex items-center justify-between">
            <p className="text-lg font-medium text-gray-600">Total Pending Order</p>
          ...
          <div className="space-y-3">
            ...
            map((order, index) => (
              ...
              <Link href={`/request-cart?orderId=${order.orderId}`} key={index}>
                <div className="p-4 border shadow-sm rounded-lg m-1 bg-white">
                  <div className="flex items-start gap-3">
                    <div className="p-2 bg-blue-50 rounded-lg">
                    ...
                    <div className="flex-1">
                      <div className="flex justify-between items-start">
                        <div>
                          <h3 className="font-medium text-yellow-700">Order Id: {order.orderId}</h3>
                      ...
                      <div className="mt-2 text-sm">
                        ...
                        <br></br>
                        <p className="text-muted-foreground"><span className="text-yellow-600">Notes :</span> {order.notes}</p>
                      </div>
                    </div>
                  </div>
                </div>
