...
const InitialProfile: React.FC = () => {
  ...
  return (
    <div className="h-screen flex flex-col items-center justify-between bg-gray-50 p-2">
      {/* Profile Section */}
      ...
      {/* QR Code Section */}
      <div className="flex flex-col items-center mt-6 border rounded-lg p-2">
        <div className="flex items-center space-x-2 mb-2">
          <button className="w-8 h-8 flex items-center justify-end text-blue-500">
