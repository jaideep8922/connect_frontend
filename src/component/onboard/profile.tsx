...
const UserProfile: React.FC = () => {
  ...
  return (
    <div className=" flex flex-col items-center justify-between bg-gray-50 p-2">
      ...
      <div className="flex absolute right-4 space-x-4 mt-2 justify-self-end">
        <a
          href={`tel:${phoneNo}`}
          className="w-12 h-12 flex items-center justify-center bg-blue-100 text-blue-500 rounded-full border"
        >
          <svg
